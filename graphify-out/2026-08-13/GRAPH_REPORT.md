# Graph Report - Engancha (2026-08-13)

## Corpus Check

- 25 files · ~28,088 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 378 nodes · 368 edges · 29 communities (25 shown, 4 thin omitted)
...
- 006-worker-processa-job-de-verificacao.md
- Épico candidato E — Conversas, contatos e leads
- graphify reference: query, path, explain
- 007-validacao-e-documentacao-do-slice-local.md
...
Cohesion: 0.05
Nodes (44): 10. Épicos candidatos consolidados, 11. Dependências entre épicos, 12. Decisões ainda necessárias antes das histórias, 1. Objetivo do documento, 3. Convenções, 4. Escopo do MVP, 5. Requisitos funcionais, 7.1 Automação (+36 more)
...
### Community 14 - "006-worker-processa-job-de-verificacao.md"

Cohesion: 0.33
Nodes (5): Acceptance criteria, Blocked by, Parent, Result, What to build
...
### Community 17 - "007-validacao-e-documentacao-do-slice-local.md"

Cohesion: 0.33
Nodes (5): Acceptance criteria, Blocked by, Parent, Result, What to build

### Community 18 - "5.1 Contrato transversal de canais e providers"
...
- **306 isolated node(s):** `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)`, `Step 1 - Ensure graphify is installed`, `Step 2 - Detect files` (+301 more)
...
- **Why does `Engancha — Requisitos Funcionais` connect `Engancha — Requisitos Funcionais` to `Épico candidato C — Criação e gestão de automações`, `Épico futuro — Integração real com Instagram/Meta`, `6. Regras de negócio transversais`, `Épico candidato D — Simulação de comentários e automações`, `8. Contratos mínimos de API`, `Épico candidato E — Conversas, contatos e leads`, `5.1 Contrato transversal de canais e providers`, `Épico candidato B — Organizations e workspaces`, `2. Perfis e atores`, `ARCHITECTURE.md`?**
  _High betweenness centrality (0.290) - this node is a cross-community bridge._
- **Why does `Engancha — Roadmap` connect `Engancha — Roadmap` to `ARCHITECTURE.md`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `Engancha — Architecture` connect `Engancha — Architecture` to `ARCHITECTURE.md`?**
