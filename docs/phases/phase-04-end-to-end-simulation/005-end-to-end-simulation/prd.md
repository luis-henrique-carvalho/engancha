...
- [001 — Comentário idempotente cria execução consultável](./tickets/001-idempotent-comment-creates-queryable-execution.md)
- [002 — Worker encontra revisão publicada ou ignora comentário](./tickets/002-worker-finds-published-revision-or-ignores-comment.md)
- [003 — Jornada simulada com resposta, DM e link](./tickets/003-simulated-journey-with-reply-dm-and-link.md)
- [004 — Captura de e-mail termina em solicitação simulada](./tickets/004-email-capture-ends-with-simulated-request.md)
- [005 — Falha e reprocessamento preservam idempotência](./tickets/005-failure-and-reprocessing-preserve-idempotency.md)
- [006 — Execução atualiza por SSE com recuperação HTTP](./tickets/006-execution-updates-via-sse-with-http-recovery.md)
- [007 — Aba Testar apresenta experiência do seguidor](./tickets/007-test-tab-presents-follower-experience.md)
- [008 — Aba Atividade agrupa interações e recupera falhas](./tickets/008-activity-tab-groups-interactions-and-recovers-failures.md)
- [009 — Observabilidade e logs estruturados do pipeline de simulação](./tickets/009-simulation-pipeline-observability-and-structured-logging.md)
- [010 — Filtros por status, plataforma e modo, busca textual e paginação na aba de atividade](./tickets/010-activity-tab-filters-search-and-pagination.md)
- [011 — Limites de requisição para operações de simulação](./tickets/011-simulation-operation-rate-limits.md)
- [012 — Limites de conexões SSE de simulação](./tickets/012-simulation-sse-connection-limits.md)
- [013 — Encerramento verificável da Fase 4](./tickets/013-phase-4-verifiable-completion.md)
