...
blocked_by: ["docs/phases/phase-04-end-to-end-simulation/005-end-to-end-simulation/tickets/003-simulated-journey-with-reply-dm-and-link.md"]
user_stories: [3]
---

## Parent

PRD `docs/phases/phase-04-end-to-end-simulation/005-end-to-end-simulation/prd.md`; cobre `FR-SIM-006`, amplia `FR-SIM-007` e atende à User Story 3 sem antecipar `FR-DATA-001` a `FR-DATA-006`.
