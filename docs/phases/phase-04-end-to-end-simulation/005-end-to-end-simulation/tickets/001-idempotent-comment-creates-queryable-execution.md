...
PRD `docs/phases/phase-04-end-to-end-simulation/005-end-to-end-simulation/prd.md`; cobre `FR-SIM-001`, a base de `FR-SIM-007`, `FR-CHANNEL-001` a `FR-CHANNEL-003`, `FR-CHANNEL-009`, `RN-001`, `RN-006` a `RN-009` e as User Stories 1, 8 e 9.
