...
PRD `docs/phases/phase-04-end-to-end-simulation/005-end-to-end-simulation/prd.md`; cobre os requisitos operacionais e de qualidade de `FR-SIM-001` a `FR-SIM-008`, isolamento de dados sensíveis e as User Stories 8 e 9.
