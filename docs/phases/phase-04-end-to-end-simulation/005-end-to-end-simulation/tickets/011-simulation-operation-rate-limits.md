...
PRD `docs/phases/phase-04-end-to-end-simulation/005-end-to-end-simulation/prd.md`; fecha o requisito de qualidade que protege os endpoints de simulação sem alterar o fluxo determinístico de idempotência, retry ou reconexão.
