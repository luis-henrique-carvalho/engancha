...
blocked_by: ["docs/phases/phase-04-end-to-end-simulation/005-end-to-end-simulation/tickets/002-worker-finds-published-revision-or-ignores-comment.md"]
user_stories: [3, 8, 9]
---

## Parent

PRD `docs/phases/phase-04-end-to-end-simulation/005-end-to-end-simulation/prd.md`; cobre `FR-SIM-003` a `FR-SIM-005`, amplia `FR-SIM-007`, aplica `RN-003` a `RN-005` e atende às User Stories 3, 8 e 9.
