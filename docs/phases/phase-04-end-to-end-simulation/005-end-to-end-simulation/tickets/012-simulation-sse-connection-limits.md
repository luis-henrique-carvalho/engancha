...
PRD `docs/phases/phase-04-end-to-end-simulation/005-end-to-end-simulation/prd.md`; fecha o requisito de qualidade de limitar conexões SSE, preservando PostgreSQL como fonte de verdade e a recuperação por HTTP.
