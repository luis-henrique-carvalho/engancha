...
- [001 — Monorepo executável e shell web](./tickets/001-executable-monorepo-and-web-shell.md)
- [002 — Runtime Nest, configuração e operação](./tickets/002-nest-runtime-configuration-and-operations.md)
- [003 — Infraestrutura local e health checks](./tickets/003-local-infrastructure-and-health-checks.md)
- [004 — Contrato do job e registro de filas](./tickets/004-job-contract-and-queue-registration.md)
- [005 — API enfileira job de verificação](./tickets/005-api-enqueues-verification-job.md)
- [006 — Worker processa job de verificação](./tickets/006-worker-processes-verification-job.md)
- [007 — Validação e documentação do slice local](./tickets/007-local-slice-validation-and-documentation.md)
- [008 — Referência local do shadcn-admin e grafo separado](./tickets/008-local-shadcn-admin-reference-and-separate-graph.md)
