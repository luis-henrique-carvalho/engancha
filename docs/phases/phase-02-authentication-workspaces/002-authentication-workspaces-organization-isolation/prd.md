...
- [001 — Cadastro e sessão e-mail/senha com Prisma e Better Auth](./tickets/001-sign-up-and-email-password-session-with-prisma-and-better-auth.md)
- [002 — Confirmação de e-mail e entrega Resend por fila](./tickets/002-email-confirmation-and-resend-queue-delivery.md)
- [003 — Recuperação de senha e logout](./tickets/003-password-recovery-and-logout.md)
- [004 — Login Google e vínculo seguro de contas](./tickets/004-google-login-and-secure-account-linking.md)
- [005 — Workspace padrão e contexto ativo](./tickets/005-default-workspace-and-active-context.md)
- [006 — Guard de Organization e isolamento multi-tenant](./tickets/006-organization-guard-and-multitenant-isolation.md)
