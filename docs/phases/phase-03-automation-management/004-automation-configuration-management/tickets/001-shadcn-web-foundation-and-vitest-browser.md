...
PRD `docs/phases/phase-03-automation-management/004-automation-configuration-management/prd.md`; prepara a base de ferramentas, configuração de componentes e infraestrutura de testes no navegador para o frontend de automações.
