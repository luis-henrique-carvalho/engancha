...
blocked_by: ["docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/010-pausing-and-editing-active-automations.md"]
user_stories: [1, 4, 6]
---

## Parent

PRD `docs/phases/phase-03-automation-management/004-automation-configuration-management/prd.md`; cobre a proteção contra perda acidental de dados locais e o tratamento de conflitos de gatilho na publicação.
...
- docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/010-pausing-and-editing-active-automations.md
