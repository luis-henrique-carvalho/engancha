...
blocked_by: ["docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/007-public-reply-and-direct-message-steps.md"]
user_stories: [4]
---

## Parent

PRD `docs/phases/phase-03-automation-management/004-automation-configuration-management/prd.md`; cobre a configuração da ação final exclusiva (`LINK` ou `CAPTURE_EMAIL`).
...
- docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/007-public-reply-and-direct-message-steps.md
