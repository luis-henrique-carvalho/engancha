...
blocked_by: ["docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/009-review-and-publish-step.md"]
user_stories: [5, 6]
---

## Parent

PRD `docs/phases/phase-03-automation-management/004-automation-configuration-management/prd.md`; cobre a User Story 5 e 6 (pausa de automações ativas e edição de rascunhos sem afetar a versão publicada).
...
- docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/009-review-and-publish-step.md
