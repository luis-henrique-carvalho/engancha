...
blocked_by: ["docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/006-keyword-step-and-normalization.md"]
user_stories: [4]
---

## Parent

PRD `docs/phases/phase-03-automation-management/004-automation-configuration-management/prd.md`; cobre a configuração das ações obrigatórias `PUBLIC_REPLY` e `PRIVATE_REPLY` com garantia da ordem determinística.
...
- docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/006-keyword-step-and-normalization.md
