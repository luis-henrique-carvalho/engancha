...
blocked_by: ["docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/003-draft-creation-and-guided-editor-layout.md"]
user_stories: [2, 4]
---

## Parent

PRD `docs/phases/phase-03-automation-management/004-automation-configuration-management/prd.md`; cobre a configuração inicial do nome da automação e a mecânica de formulário por etapa com salvamento explícito.
...
- docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/003-draft-creation-and-guided-editor-layout.md
