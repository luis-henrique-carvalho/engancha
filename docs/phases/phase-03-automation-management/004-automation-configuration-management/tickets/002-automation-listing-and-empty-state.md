...
blocked_by: ["docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/001-shadcn-web-foundation-and-vitest-browser.md"]
user_stories: [1]
---

## Parent

PRD `docs/phases/phase-03-automation-management/004-automation-configuration-management/prd.md`; cobre a User Story 1 (listagem das automações do workspace ativo com seus respectivos estados).
...
- docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/001-shadcn-web-foundation-and-vitest-browser.md
