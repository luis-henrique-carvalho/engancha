...
blocked_by: ["docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/002-automation-listing-and-empty-state.md"]
user_stories: [2]
---

## Parent

PRD `docs/phases/phase-03-automation-management/004-automation-configuration-management/prd.md`; cobre a User Story 2 (criação de rascunho de automação e estrutura de navegação do editor).
...
- docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/002-automation-listing-and-empty-state.md
