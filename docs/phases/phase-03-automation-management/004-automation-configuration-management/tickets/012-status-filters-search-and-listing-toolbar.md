...
status: "needs-triage"
type: "AFK"
parent: "docs/phases/phase-03-automation-management/004-automation-configuration-management/prd.md"
blocked_by: ["docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/011-navigation-protection-and-trigger-conflicts.md"]
user_stories: [1]
---

## Parent

PRD `docs/phases/phase-03-automation-management/004-automation-configuration-management/prd.md`; estende a listagem de automações com capacidades de busca textual, filtragem facetada por status e controle de visibilidade de colunas via `DataTableToolbar`.
...
- docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/011-navigation-protection-and-trigger-conflicts.md
