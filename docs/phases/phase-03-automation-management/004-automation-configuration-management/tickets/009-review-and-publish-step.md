...
blocked_by: ["docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/008-final-action-link-or-email-capture-step.md"]
user_stories: [5, 6]
---

## Parent

PRD `docs/phases/phase-03-automation-management/004-automation-configuration-management/prd.md`; cobre a User Story 6 e a consolidação do resumo, checklist de validação e publicação de automação.
...
- docs/phases/phase-03-automation-management/004-automation-configuration-management/tickets/008-final-action-link-or-email-capture-step.md
