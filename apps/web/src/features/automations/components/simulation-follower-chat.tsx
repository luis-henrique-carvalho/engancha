...
export function SimulationFollowerChat({
  ...
  return (
    <Card className="h-full flex flex-col" data-testid="simulation-follower-chat-card">
      ...
      >
        {/* Empty State */}
        {!execution && !isSubmitting && !isLoading && (
          <div
          ...
          >
            ...
            <p className="mt-1 max-w-xs text-xs text-muted-foreground">
              Envie um comentário pelo formulário ao lado para acompanhar a resposta pública, a
              mensagem direta e a ação final.
            </p>
          </div>
        )}

        {/* Submitting / Initial Loading State */}
        {(isSubmitting || (isLoading && !execution)) && (
          <div
        ...
        {execution && (
          <div className="space-y-4">
            ...
            {execution.status === 'IGNORED' && (
              ...
              >
                ...
                <AlertDescription className="text-xs">
                  Nenhuma automação ativa reconheceu a palavra-chave configurada para esta
                  publicação.
                </AlertDescription>
              </Alert>
            )}
            ...
            {/* Step 4: Final Action - LINK_DELIVERY */}
            ...
            {/* Step 4: Final Action - EMAIL_CAPTURE_REQUEST */}
            {outputs.emailCapture && (
              ...
              >
                ...
                >
                  ...
                  <span>
                    Simulação: a jornada encerra na solicitação. Nenhum dado real foi coletado.
                  </span>
                </div>
              </div>
            )}

            {/* Processing / Progressing indicator */}
